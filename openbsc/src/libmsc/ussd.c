...
//	snprintf(response_string, sizeof(response_string), "Padiush lu Bue Xhidza (Telefonia Celular Comunitaria Sta Ma Yaviche). Numero kiu naka %s chibarecnu guineznu chia buliza lu 10610\r", own_number);
